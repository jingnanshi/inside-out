...
{
   AudioSample jingle = minim.loadSample("bach_air_harpsichord.mp3", 2048);
...
{
  int fftSize = 1024;
  AudioRecordingStream stream = minim.loadFileStream("bach_air_harpsichord.mp3", fftSize, false);
